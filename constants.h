...
#define RES_DIVIDER         5           // Higher values will result in lower horizontal resolution when rasterize and lower process and memory usage
...
#define MAX_ENTITIES          6          // Max num of active entities
...
#define ENEMY_MELEE_DIST      1           // * DISTANCE_MULTIPLIER
#define WALL_COLLIDER_DIST    .2

#define ENEMY_MELEE_DAMAGE    1000
#define ENEMY_FIREBALL_DAMAGE 1
#define GUN_MAX_DAMAGE        100
